...
function bullet()
{
    ...
    proj.style.borderRadius = "20px";
    proj.style.margin = "25px";
...
document.addEventListener("click",function(e){
    if(e.target.getAttribute("class") != "grid" && e.target.getAttribute("class") != "hover" && !selected && e.target.getAttribute("colour") == turn)
    {
    ...
    else if(selected && e.target.getAttribute("class") == "hover")
    {
        move([e.target.style.gridRow, e.target.style.gridColumn]);
    }
    else if(selected && e.target.getAttribute("class") == "myhover")
    {
        rotate();
    }
    else if(selected && (e.target.getAttribute("class") == "turnclock" || e.target.getAttribute("class") == "turnanticlock"))
    {
